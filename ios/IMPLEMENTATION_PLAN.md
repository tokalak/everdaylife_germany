...
| Shared core | Decoder (local inference), Vault, Calendar, Settings | **Decoder vertical slice built (P3-00…03):** readiness/consent gate, Vision OCR capture, structured on-device explain (grammar + validate/repair), full result screen — all on `StubLLMEngine` pending the vendored runtime. Vault/Calendar/Settings (P3-05…09) not yet built |
