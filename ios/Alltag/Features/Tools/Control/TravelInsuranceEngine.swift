...
/// Ranking + filtering for the travel/visa health-insurance comparison (P6-T4).
///
...
enum TravelInsuranceEngine {
    ...
    static func rankedOptions(
        from catalog: ComparisonCatalog = TravelInsuranceCatalog.current,
