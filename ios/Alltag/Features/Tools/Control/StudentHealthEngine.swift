...
/// Ranking + filtering for the student health-insurance comparison (P6-S3).
///
...
enum StudentHealthEngine {
    ...
    static func rankedOptions(
        from catalog: ComparisonCatalog = StudentHealthCatalog.current,
